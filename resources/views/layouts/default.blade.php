                    ...
                    <div class="flex items-center justify-between border-b border-gray-200 py-4">
                        <div>
                            <div class="" role="img" aria-label="luxe. Logo.">
                                <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg1.svg" alt="logo">
                                <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg1dark.svg" alt="logo">
                            </div>
                        </div>
                        <div class="hidden md:block">
                            <ul class="flex items-center space-x-6">
                                <li>
                                    <a href="javascript:void(0)" class="text-base text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"> New </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="text-base text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"> Men </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="text-base text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"> Women </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="text-base text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"> Kids </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="text-base text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"> Magazine </a>
                                </li>
                            </ul>
                        </div>
                        <div class="hidden md:flex items-center space-x-4">
                            <a aria-label="my account" href="javascript:void(0)" class="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
                                ...
                                <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg2dark.svg" alt="account">
                            </a>
                            <a aria-label="Favourites" href="javascript:void(0)" class="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
                                ...
                                <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg3dark.svg" alt="Favourites">
                            </a>
                            <a aria-label="Bag" href="javascript:void(0)" class="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
                                ...
                                <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg4dark.svg" alt="bag">
                            </a>
                        </div>

                        <div class="md:hidden">
                            <button aria-label="open menu" onclick="openMenu()" class="focus:outline-none focus:ring-2 focus:ring-gray-800 rounded">
                                <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg5.svg" alt="toggler">
                                <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg5dark.svg" alt="toggler">
                            </button>
                        </div>
                    </div>
                    <div class="mt-4 pb-4 flex space-x-3 border-b border-gray-200">
                        <div>
                            <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg6.svg" alt="Search">
                            <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg6dark.svg" alt="Search">
                        </div>
                        <input type="text" placeholder="Search for products" class="focus:outline-none bg-transparent text-sm text-gray-600" />
                    </div>
                </div>

                <div id="mobile-menu" class="hidden md:hidden absolute inset-0 z-10 flex flex-col w-full h-screen bg-white pt-6">
                    <div class="w-full">
                        <div class="flex items-center justify-between border-b border-gray-200 pb-3 mx-4">
                            ...
                            <button aria-label="close menu" onclick="closeMenu()" class="text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800">
                                <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg7.svg" alt="logo">
                                <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg7dark.svg" alt="logo">
                            </button>
                        </div>
                    </div>
                    <div class="mt-4 mx-4">
                        <ul class="flex flex-col space-y-4">
                            <li class="border-b border-gray-200 pb-4 px-1 flex items-center justify-between">
                                <a href="javascript:void(0)" class=" focus:outline-none focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline"> New </a>
                                <button aria-label="Add" class=" text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                </button>
                            </li>
                            <li class="border-b border-gray-200 pb-4 px-1 flex items-center justify-between">
                                <a href="javascript:void(0)" class=" focus:outline-none focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline"> Men </a>
                                <button aria-label="Add" class=" text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                </button>
                            ...
                            <li class="border-b border-gray-200 pb-4 px-1 flex items-center justify-between">
                                <a href="javascript:void(0)" class=" focus:outline-none focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline"> Women </a>
                                <button aria-label="Add" class=" text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                </button>
                            ...
                            <li class="border-b border-gray-200 pb-4 px-1 flex items-center justify-between">
                                <a href="javascript:void(0)" class=" focus:outline-none focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline"> Kids </a>
                                <button aria-label="Add" class=" text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                </button>
                            ...
                            <li class="border-b border-gray-200 pb-4 px-1 flex items-center justify-between">
                                <a href="javascript:void(0)" class=" focus:outline-none focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline"> Magazine </a>
                                <button aria-label="Add" class=" text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                    <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg8.svg" alt="add">
                                </button>
                    ...
                    <div class="w-full h-full flex items-end">
                        <ul class="bg-gray-50 py-10 px-4 flex flex-col space-y-8 w-full">
                            <li>
                                <a class="flex items-center space-x-2 focus:outline-none text-gray-800  focus:ring-2 focus:ring-gray-800 hover:underline" href="javascript:void(0)">
                                    <div>
                                        <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg2.svg" alt="account">
                                        <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg2dark.svg" alt="account">
                                    </div>
                            ...
                            <li>
                                <a class="flex items-center space-x-2 text-gray-800  focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline" href="javascript:void(0)">
                                    <div>
                                        <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg3.svg" alt="Favourites">
                                        <img class="" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-III-svg3dark.svg" alt="Favourites">
                                    </div>
...
{{-- FOOTER BEGINS --}}
        <div class="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
            <div class="flex flex-col items-center justify-center">
                <div>
                    <svg class="text-gray-800  hover:text-gray-500" width="111" height="19" viewBox="0 0 111 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                    <a href="javascript:void(0)" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">About</a>
                    <a href="javascript:void(0)" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Contact us</a>
                    <a href="javascript:void(0)" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Terms of Service</a>
                    <a href="javascript:void(0)" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-800">Privacy Policy</a>
                </div>
                ...
                <div class="flex items-center mt-6">
                    <p class="text-base leading-4 text-gray-800 ">2021 <span class="font-semibold">Luxiwood</span></p>
