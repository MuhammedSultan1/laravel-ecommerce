...
{{-- EXPLORE BY CATEGORY SECTION BEGINS --}}
...
{{-- EXPLORE BY CATEGORY SECTION ENDS --}}
            ...
            <div class="flex justify-center">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 lg:mt-16 md:mt-12 mt-8 items-center">
                    <div class="relative flex flex-col">
                        <img src="photos/kids_collection.jpeg" alt="people" class="w-full h-full" />
                        <img src="photos/kids_collection.jpeg" alt="opacity bg" class="absolute w-full h-full top-0" />
                    ...
                    <div class="relative flex flex-col">
                        <img src="photos/mens_clothing.jpeg" alt="man with a motorbike" class="w-full" />
                        <img src="photos/mens_clothing.jpeg" alt="opacity bg" class="absolute w-full top-0" />
                        <div class="absolute m-6 bottom-0 z-30">
                            <p class="text-sm leading-none text-white">Special collection</p>
                            <h1 class="w-64 text-2xl font-semibold leading-8 mt-2 text-white">New Monochrome Collection</h1>
                            <p class="mt-4 text-base font-medium cursor-pointer leading-4 underline text-white">Discover</p>
                    ...
                    <div class="relative flex flex-col">
                        <img src="photos/teens_collection.jpeg" alt="boy" class="w-full h-full" />
                        <img src="photos/teens_collection.jpeg" alt="opacity bg" class="absolute w-full h-full top-0" />
                        <div class="absolute m-6 bottom-0 z-30">
                            <p class="text-sm leading-none text-white">Special collection</p>
                            <h1 class="w-64 text-2xl font-semibold leading-8 mt-2 text-white">New Monochrome Collection</h1>
                            <p class="mt-4 text-base font-medium cursor-pointer leading-4 underline text-white">Discover</p>
